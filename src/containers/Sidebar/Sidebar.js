          ...
          <Scrollbars style={{ height: scrollheight - 70 }}>
            ...
            >
              ...
              <SubMenu
                ...
                title={
                  <span className="isoMenuHolder" style={submenuColor}>
                    <i className="ion-bag" />
                    <span className="nav-text">
                      <IntlMessages id="sidebar.identity" />
                    </span>
                  </span>
                }
              >
                ...
                <Menu.Item style={submenuStyle} key="group">
                  <Link style={submenuColor} to={`${url}/group`}>
                    <IntlMessages id="sidebar.group" />
                  </Link>
                </Menu.Item>
              ...
              >
                ...
                <Menu.Item style={submenuStyle} key="echart"> //This is menu item is bydefault comment..
              ...
              {/* <Menu.Item key="grid_layout"> //This menu item by default comment
              ...
              >
                ...
                <Menu.Item style={submenuStyle} key="comingSoon"> // This menu item by default comment
